    ...
    <section className=" body-about ">
      ...
      >
        <div className="lg:max-w-lg lg:w-full md:w-[40%] w-5/6 mb-10 md:mb-0">
          <img src="/image/about.webp" alt="about" className="img" />
        </div>
        ...
        <div className="lg:flex-grow md:w-[60%] lg:pl-14 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="font mb-8 leading-relaxed text-left ">
            Welcome to Our library is a welcoming space for readers and learners
            of all ages. 
            We offer a diverse collection of books, digital
            resources, and programs designed to inspire, educate, and connect
            our community. Whether you're here to read, study, or attend an
            event, is your place to explore, learn, and grow.
          </p>
